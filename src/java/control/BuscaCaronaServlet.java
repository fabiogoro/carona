 ...
 * @author Fabio
 */
public class BuscaCaronaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.connect();
            List<Usuario> listaUsuario = dao.buscaCarona(origem,destino,dataString);
            ServletContext context= getServletContext();
            RequestDispatcher rd= context.getRequestDispatcher("/caronas.jsp");
